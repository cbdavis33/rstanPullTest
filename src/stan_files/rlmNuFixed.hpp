...
namespace model_rlmNuFixed_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rlmNuFixed");
    reader.add_event(21, 19, "end", "model_rlmNuFixed");
    return reader;
}

#include <meta_header.hpp>
 class model_rlmNuFixed : public prob_grad {
private:
    int N;
    int K;
    matrix_d x;
    ...
    double nu;
public:
    model_rlmNuFixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rlmNuFixed_namespace::model_rlmNuFixed";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(student_t_log<propto__>(y, nu, add(alpha,multiply(x,beta)), sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_rlmNuFixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_rlmNuFixed_namespace::model_rlmNuFixed stan_model;
